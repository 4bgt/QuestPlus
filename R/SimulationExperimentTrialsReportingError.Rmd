---
title: "Simulation: Constant Stimuli vs Quest+ with Error in response, Experiment Parameters and varying number of trials "
author: "Niklas Stein"
date: "`r Sys.Date()`"
...
library(ggplot2)
library(quickpsy)
for (repeatedTrials in c(3:4))
{
  #### Constant Stimuli ####
  constantStimuliTest <- read_csv(paste0("constantStimuliReportingError",repeatedTrials,".csv"),show_col_types = FALSE)
  ...
  ##### Quest+ #####
  QuestPlusTest <- read_csv(paste0("Quest+ReportingError",repeatedTrials,".csv"))
